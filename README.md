...
## UI notes
- Home page now uses OTT-style rails (latest uploads + language collections).
- Posters use `object-fit: contain` to avoid cropping.
- Search uses fuzzy token matching (`kgf chapter` also finds `KGF Chapter 1/2`).
